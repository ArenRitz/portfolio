...
const Hero = () => {
	return (
			...
			<div className='h-full w-screen flex relative '>
				<div className='h-fit m-auto lg:m-auto w-full h lg:w-[50%] border-l-2 border-green-400'>
					<div className='ml-4 lg:ml-12 py-4 flex flex-col gap-6'>
						...
						<div className='flex text-[6vw] lg:text-[3vw] font-title font-extrabold'>
							<span
								before="Hello, I'm "
						...
						<div className='w-fit text-white text-[5vw]  lg:text-[2vw] font-bold font-title leading-none whitespace-pre'>
							{'>>'} Full Stack Developer
						</div>

						<p className=' font-primary text-white text-[4vw] lg:text-[1.25vw]'>
							Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
							eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
							enim ad minim veniam, quis nostrud exercitation ullamco laboris
						</p>

						<button className=' w-fit py-[1vw] px-[3vw] mt-6 lg:mt-12 border-[1px] lg:border-2 text-[4vw] lg:text-[1vw] rounded-full border-green-400 text-green-400 hover:bg-green-400 hover:text-black'>
							GET IN TOUCH
						</button>
					</div>
				</div>

				<button className='absolute bottom-2 lg:bottom-8 m-auto left-0 right-0 w-fit pb-2 pt-4 lg:pt-6 border-[1px] lg:border-2 rounded-full border-green-400 text-green-400 hover:bg-green-400 hover:text-black'>
